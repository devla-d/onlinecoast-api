              ...
              >
                ...
                <div class="tanktxt">
                  <h1
                    ...
                    "
                  >
                    Dear ${tx.user.first_name}  ${tx.user.last_name}
                  </h1>
                  <p
                    style="
                      font-family: 'Lato', Helvetica, Arial, sans-serif;
                  ...
                  <h4 style="font-size: 20px; font-weight: 400">
                    ...
                    <small
                      style="
                        ...
                        line-height: 18px;
                      "
                      >${(0, moment_1.default)(tx.createdAt).format("MMMM Do YYYY, h:mm:ss a")}</small
                    >
                  </h4>
                  <p>
...
exports.default = notifyTrx;
//# sourceMappingURL=notifyTxt.js.map