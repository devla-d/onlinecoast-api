...
const welcomEmail = (account_number, name, security_pin) => {
    return `
  <!DOCTYPE html>
<html>
  <head>
        ...
        <![endif]-->
          ...
          >
            <tr>
              ...
              <img src="#" alt="Welcome" width="600" style="display: block; width: 100%; max-width: 100%;">
            </td--->
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
          ...
          >
            ...
            <tr>
              ...
              >
                ...
                <p style="margin: 0">
                  Thank you for signing up with us. We are committed to meeting
                  your banking needs.
                </p>
            ...
            <tr>
              ...
              >
                <p style="margin: 0">
                  ...
                  Registrations for your account. If you didn't request
